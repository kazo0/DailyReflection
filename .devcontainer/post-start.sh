...
claude mcp add --scope user --transport stdio uno-app -- dotnet dnx --prerelease -y uno.devserver --mcp-app --solution-dir /workspace || true
...
MCP_SERVERS='{
  "mcpServers": {
    ...
    "uno-app": {
      "type": "stdio",
      "command": "dotnet",
      "args": ["dnx", "-y", "--prerelease", "uno.devserver", "--mcp-app", "--solution-dir", "/workspace"]
    }
  }
}'
