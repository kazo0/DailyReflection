...
These terms and conditions apply to the Daily Reflections app for mobile devices, Windows devices, and web browsers, together with any related services operated by Steve Bilogan (collectively, the "Application"). Steve Bilogan is hereby referred to as the "Service Provider".
...
If you believe content violates these Terms, infringes your rights, or is unlawful, you may report it to the Service Provider at steve.bilogan@gmail.com. The report should include enough information for the Service Provider to identify the content, evaluate the complaint, and contact you if follow-up is required.
...
The Service Provider may review reported content, request additional information where necessary, remove or restrict access to content, and take action against the responsible account where appropriate. Users affected by moderation decisions may contact the Service Provider at steve.bilogan@gmail.com to request further review. The Service Provider will respond to appeals within a reasonable period and provide the reasons for any upheld moderation decision, subject to applicable law.
...
The Application stores and processes personal data that you have provided to the Service Provider in order to provide the Service. It is your responsibility to maintain the security of your mobile device, Windows device, or computer and access to the Application.

The Service Provider strongly advises against jailbreaking or rooting your mobile device, Windows device, or computer, which involves removing software restrictions and limitations imposed by the official operating system of your mobile device, Windows device, or computer. Such actions could expose your mobile device, Windows device, or computer to malware, viruses, malicious programs, compromise your mobile device, Windows device, or computer's security features, and may result in the Application not functioning correctly or at all.
...
Point of Contact: The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at steve.bilogan@gmail.com. Where the Service Provider is established outside the European Union, a legal representative in the EU has been designated in accordance with Article 13 of the DSA.
...
Previous versions of these Terms and Conditions will be maintained and made available upon request by contacting the Service Provider at steve.bilogan@gmail.com.

These terms and conditions are effective as of 2026-09-22

**Contact Us**

If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at steve.bilogan@gmail.com.
